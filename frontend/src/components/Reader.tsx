...
export const Reader = ({ chapterId }: { chapterId: number }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-1/2 overflow-y-auto p-8 border-r border-slate-100 font-serif text-lg leading-relaxed text-slate-700 selection:bg-blue-100">
          <div className="max-w-2xl mx-auto whitespace-pre-wrap">
            {chapter.contentRaw}
          </div>
        </div>

        <div className="w-1/2 overflow-y-auto p-8 bg-slate-50 font-serif text-lg leading-relaxed text-slate-800 selection:bg-orange-100">
          <div className="max-w-2xl mx-auto whitespace-pre-wrap">
